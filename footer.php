<footer class="pt-5">
	<div class="container">
		<div class="row g-4 mb-4">
				...
				<div class="footer-col">
					...
					<ul class="contact-info-footer list-unstyled">
						<li class="d-flex mb-3">
							...
							<span>Purok 3, Barangay Ligaya, General Santos City, Philippines</span>
						</li>
						<li class="d-flex mb-3">
							<i class="fas fa-phone me-3 mt-1"></i>
							<span>0917 700 8092</span>
						</li>
						<li class="d-flex mb-3">
							<i class="fas fa-envelope me-3 mt-1"></i>
							<span>shiojiapartelle@gmail.com</span>
						</li>
						<li class="d-flex">
			...
			<div class="col-md-6 col-lg-3">
				<div class="footer-col">
					<h3 class="h4 mb-3">Policies</h3>
					<ul class="footer-links list-unstyled">
						<li><a href="rules.php" class="text-decoration-none d-flex align-items-center">
								<i class="fas fa-chevron-right me-2"></i> Rules & Regulations
							</a></li>
					</ul>
				</div>
			</div>
