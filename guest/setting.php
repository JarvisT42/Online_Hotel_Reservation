...
if (isset($_POST['update_profile'])) {
    // Get values from POST or session
    $first_name = $_POST['first_name'];
    $last_name  = $_POST['last_name'];
    $email      = $_POST['email'];


    // Update query for first_name, last_name, email, and username
    $stmt = $conn->prepare("UPDATE guests SET first_name = ?, last_name = ?, email = ? WHERE guest_id = ?");
    $stmt->bind_param("sssi", $first_name, $last_name, $email, $guest_id);
...
if (isset($_POST['change_password'])) {
    ...
    if ($newPassword !== $confirmPassword) {
        ...
        $stmt = $conn->prepare("SELECT password FROM guests WHERE guest_id = ?");
        ...
        if (!password_verify($currentPassword, $hashedPassword)) {
            ...
            $stmt = $conn->prepare("UPDATE guests SET password = ? WHERE guest_id = ?");
            $stmt->bind_param("si", $newHashedPassword, $guest_id);
    ...
    <div class="main-content">
        ...
        <div class="topbar">
            ...
            <div class="user-info">
                ...
                <img src="https://www.w3schools.com/howto/img_avatar.png" alt="guest Avatar" class="rounded-circle" width="40" height="40">
                <div>
                    <div class="fw-bold">
                    ...
                    <div class="text-muted small">guestistrator</div>
                </div>
        ...
        <div class="settings-container">
                ...
                <form action="" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" class="form-control" id="email" name="email"
                            value="<?php echo isset($_SESSION['guest_email']) ? htmlspecialchars($_SESSION['guest_email']) : ''; ?>">
                    </div>
            ...
            <div class="settings-card">
                ...
                <form action="" method="POST">
                    <input type="hidden" name="guest_id" value="1"> <!-- or from session -->
                    <div class="form-group">
